...
public final class CustomerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<br.com.mj.CustomerRequest,
      br.com.mj.CustomerResponse> getSaveMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Save",
      requestType = br.com.mj.CustomerRequest.class,
      responseType = br.com.mj.CustomerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<br.com.mj.CustomerRequest,
      br.com.mj.CustomerResponse> getSaveMethod() {
    io.grpc.MethodDescriptor<br.com.mj.CustomerRequest, br.com.mj.CustomerResponse> getSaveMethod;
      ...
      synchronized (CustomerServiceGrpc.class) {
        if ((getSaveMethod = CustomerServiceGrpc.getSaveMethod) == null) {
          CustomerServiceGrpc.getSaveMethod = getSaveMethod =
              io.grpc.MethodDescriptor.<br.com.mj.CustomerRequest, br.com.mj.CustomerResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Save"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.mj.CustomerRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.mj.CustomerResponse.getDefaultInstance()))
  ...
  public static abstract class CustomerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void save(br.com.mj.CustomerRequest request,
        io.grpc.stub.StreamObserver<br.com.mj.CustomerResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                br.com.mj.CustomerRequest,
                br.com.mj.CustomerResponse>(
                  this, METHODID_SAVE)))
          .build();
    }
  }
  ...
  public static final class CustomerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CustomerServiceBlockingStub> {
    ...
    /**
     */
    public br.com.mj.CustomerResponse save(br.com.mj.CustomerRequest request) {
  ...
  public static final class CustomerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CustomerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<br.com.mj.CustomerResponse> save(
        br.com.mj.CustomerRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAVE:
          serviceImpl.save((br.com.mj.CustomerRequest) request,
              (io.grpc.stub.StreamObserver<br.com.mj.CustomerResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CustomerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return br.com.mj.Customer.getDescriptor();
    }
